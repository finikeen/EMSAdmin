<cfcomponent displayName="Controller" extends="Singleton" hint="Receives events and sends them to the appropriate Service to handle the event.">
	...
	<cffunction name="broadcastEvent" access="remote" returntype="any">
		...
		<cfset service = APPLICATION.emsadmin.objectFactory.getObjectByName(cfcName=objectType, cfcType=cfcType, cfcPath=cfcPath)>
		...
		<cfelse>
			<cfset eventResult = APPLICATION.emsadmin.objectFactory.getObjectByName("EventResult","bean","event")>
