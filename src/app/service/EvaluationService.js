Ext.define('Adm.service.EvaluationService', {
    ...
    getBaseUrl: function(){
        var me = this;
        var baseUrl = me.apiProperties.createUrl(me.apiProperties.getItemUrl('updateform'));
        return baseUrl;
    },
    ...
    update: function(jsonData, callbacks){
        var me = this;
        var id = jsonData.studentEvaluationId;
