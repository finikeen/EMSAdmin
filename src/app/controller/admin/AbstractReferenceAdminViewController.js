Ext.define('Adm.controller.admin.AbstractReferenceAdminViewController', {
	...
	addRecord: function(button){
		...
		var item = Ext.create( store.model.modelName, {});
    ...
    deleteConfirmation: function( button ) {
       ...
       if (selection != null && selection.get('id') ) 
       {
    	   ...
    	   if ( !Adm.util.Constants.isRestrictedAdminItemId( selection.get('id')  ) )
    	   {
