Ext.define('Adm.mixin.ApiProperties', { 
    ...
    statics: {
        getBaseApiUrl: function(){
            ...
            return base.substr(0, base.indexOf("/", base.indexOf("//") + 2) + 1) + '/emsadmin/api/' + apiVersion + '/index.cfm/';
        },
		
        getRemoteApiUrl: function(){
            var apiVersion = "1";
            /* var base = document.getElementsByTagName('base')[0];
            if (base && base.href && (base.href.length > 0)) {
                base = base.href;
            ...
            return base.substr(0, base.indexOf("/", base.indexOf("//") + 2) + 1) + '/emsadmin/api/' + apiVersion + '/index.cfm/'; */
            return 'http://rest.sinclair.edu/api/' + apiVersion + '/index.cfm/';
        },
        ...
        getBaseAppUrl: function(){
            ...
            return base.substr(0, base.indexOf("/", base.indexOf("//") + 2) + 1) + 'emsadmin';
        }
    },
    ...
    createRemoteUrl: function(value){
        return Adm.mixin.ApiProperties.getRemoteApiUrl() + value;
    },
