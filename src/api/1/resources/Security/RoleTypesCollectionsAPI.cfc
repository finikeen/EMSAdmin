component displayname="RoleTypesCollectionsAPI" extends="emsadmin.api.1.resources.AbstractCollectionsAPI" taffy_uri="/RoleTypes/"
{	
	variables.service = Application.security.objectFactory.getObjectByName("RoleTypes","service","security");
