component displayname="Security_VerifyLoginCookiesCollectionsAPI" extends="emsadmin.api.1.resources.AbstractRestAPI" taffy_uri="/verifyLoginCookies"
{
	variables.service = Application.security.objectFactory.getObjectByName("security", "service", 
                                                                        "security");
