...
Ext.ux.Printer.ContainerRenderer = Ext.extend(Ext.ux.Printer.BaseRenderer, {
	generateBody: function(container) {
		return String.format("<div class='x-panel-print'>{0}</div>", container.body.dom.innerHTML);
	}
});
...
Ext.ux.Printer.FormRenderer = Ext.extend(Ext.ux.Printer.BaseRenderer, {
	generateBody: function(form) {
		return String.format("<div class='x-panel-print'>{0}</div>", form.body.dom.innerHTML);
	}
});
Ext.ux.Printer.registerRenderer('form', Ext.ux.Printer.FormRenderer);
...
Ext.ux.Printer.BaseRenderer.prototype.stylesheetPath = 'resources/css/Ext.ux.Printer.css';
